...
<img class="imgBorder" src="../images/resreg/resreg1.png" alt="resreg 1"> <br />
</p>

<li>Click "Log In"</li>
<img class="imgBorder" src="../images/resreg/resreg2.png" alt="resreg 2">

<li>Enter your BearPass login and BearPass password</li>
<img class="imgBorder" src="../images/resreg/resreg3.png" alt="resreg 3">
