...
<body>
	...
	<?php include_once("../includes/header_primary.inc.php") ?>
            ...
            <p class="answer">
              ...
              Outlined below are guides on how to find the MAC address for supported devices.
              If you already know the MAC address of your wired device, you may register it at <a href="http://resreg.missouristate.edu" title="ResReg">http://resreg.missouristate.edu</a>.  
            </p>
