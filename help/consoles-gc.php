...
<title>Resnet :: Tutorials :: Game Consoles :: Nintendo Gamecube Registration and Configuration</title>
</head>
	...
	<?php include_once("../includes/header_secondary.inc.php") ?>
            ...
            <ol>
                ...
                <li>
       			 ...
       			 <li>
                    Once you have this MAC address, you may proceed to <a href="http://resreg.missouristate.edu" title="ResReg">
                    http://resreg.missouristate.edu</a> and register your GameCube.
                </li>

             </ol>
				<img class="imgBorder" src="../images/consoles/consoles-gc-01.jpg" alt="GameCube Broadband Adapter" width="369" height="244">
