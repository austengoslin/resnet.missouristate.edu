				<div id = "boxWrap">
				  <div id = "box">
						<h3 class="sidePanelHeader">Useful Information</h3>
                        <ul>
                        	<li><a href="../info/safeCompute.php">Safe Computing Practices</a></li>
                            <li><a href="../info/bandwidth.php">Bandwidth Quota</a></li>
                            <li><a href="../info/security.php">Network Security</a></li>
                            <li><a href="../info/print.php">Print Quota</a></li>
                            <li><a href="../labs/index.php">Computer Labs</a>
                            	<ul>
