...
<body>
	...
	<?php include_once("../includes/header_primary.inc.php") ?>
			...
			<p class="indent">
                ...
                midnight each night. The cap is currently 200 gigabytes combined incoming (download) and outgoing (upload) traffic per 
				...
				<br /><br />
                Below, you can see a graph of the current network use (a graph for the campus' current Internet usage can be found on <a href="https://networking.missouristate.edu/UtilGraphs.aspx">Networking Service's site</a>).  
            ...
            <ol><li class="indent">
                ...
                <li class="indent">
				  ...
				  Turn it off when you are not listening or watching it.
                  Even if their data stream is small, it can quickly accrue a significant amount of traffic.  
                  This can also include other applications that involve steaming media, such as Skype or other software.
              </li>
                <li class="indent">
                  Lastly, file-sharing or downloading programs (Limewire, BitTorrent, etc.) typically cause the highest amount of network traffic.
          		...
          		<p class="answer">
                	...
                	or the open access computer labs (417 836-5891 opt. #4) for assistance.
           	  </p>
