...
<body>
	...
	<?php include_once("../includes/header_primary.inc.php"); ?>
			...
			<ol class="indent">			
            	...
            	<li>
                    Select the E-mail icon from the application drawer </li>
                    <img class="imgBorder" src="../images/bearmail/bearmail-liveedu-android1.png" alt="E-mail icon">
                <li>
				...
				<li>
                    ...
                    <img class="imgBorder" src="../images/bearmail/bearmail-liveedu-android2.png" alt="Setup Screen 1" width="220">
                <li>
                    Select "Exchange account"                
                </li>    
                    <img class="imgBorder" src="../images/bearmail/bearmail-liveedu-android3.png" alt="Manual Setup Screen" width="220">
                <li>
                    The following screen should appear as your phone checks the settings.
                    </li>
                    <img class="imgBorder" src="../images/bearmail/bearmail-liveedu-android4.png" alt="Checking incoming settings" width="220">
				...
				<li>
                    ...
                    <img class="imgBorder" src="../images/bearmail/bearmail-liveedu-android5.png" alt="Remote Administration" width="220">
					<li>
                    ...
                    <img class="imgBorder" src="../images/bearmail/bearmail-liveedu-android6.png" alt="Manual Setup Screen" width="220">
