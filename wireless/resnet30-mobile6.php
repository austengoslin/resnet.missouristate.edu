...
<title>Resnet :: Tutorials :: Wireless :: Configuring Resnet 30 on Windows Mobile 6</title>
...
<body>
	...
	<?php include_once("../includes/header_primary.inc.php") ?>
    		...
    		<div id="tutorial"> 
              <!-- start content -->		
                <h2>Configuring Resnet 30 on Windows Mobile 6</h2>
                
              <p class="answer">
                    In this tutorial we are using Windows Mobile 6; however, these instructions should also work with Windows Mobile 5.
                </p>
                <ol class="indent">
                	<li>Navigate to <strong>Start</strong> &raquo; <strong>Settings</strong> &raquo; <strong>Connections</strong> &raquo; <strong>WiFi</strong>.</li>
                    <li>Select "resnet 30" from the list.</li>
                        <img class="imgBorder" src="../images/wireless/wireless-resnet30-mobile6-1.png" alt="wireless-mobile6-1">
                    <li>Set "Connects to:" to <strong>The Internet</strong>. <br />
                    </li>
                        <img class="imgBorder" src="../images/wireless/wireless-resnet30-mobile6-2.png" alt="wireless-mobile6-2">
                    <li>On the "Network Key" tab, use the folloing settings:
                     ...
                     <li>On the "802.1x" tab, ensure that the <strong>Use IEEE 802.1x network access control</strong> is checked and set "EAP type:" to <strong>PEAP</strong>.</li>
                        <img class="imgBorder" src="../images/wireless/wireless-access30-mobile6-4.png" alt="wireless-mobile6-4">
                    <li>Once complete click "Finish" in the bottom right corner of the screen. </li> 
                        Select "resnet 30" and click "Connect".  
                        ...
                        <li>After a few seconds your device will connect to "resnet 30".</li>
                </ol> 
                <p class="answer">
