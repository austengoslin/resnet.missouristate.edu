...
<title>Resnet :: Tutorials :: Wireless :: Configuring Access 30 on Ubuntu</title>
...
<body>
	...
	<?php include_once("../includes/header_secondary.inc.php") ?>
		...
		<!-- start content -->		
            ...
            As always, <a href="http://www.google.com" title="Google">Google</a> is your friend.  
		...
		<ol class="indent">
        	<li>To access the wireless network, you will need to install a few additional files.  
				The needed packages are available through the Synaptic Package Manager or through apt-get in Terminal.  
				In this example, we will use the Add/Remove Applications menu. </li> 
		
			<li>From the "Applications" menu, select "Add/Remove..."</li>
		<img class="imgBorder" src="../images/wireless/wireless-ubuntu-01.png" alt="wireless-ubuntu-01">
		<li>Under the "Internet" section of the Add/Remove Applications menu, select "Network Manager" and click "Apply".  
		<em>(An option for KDE users might be installing <span class="italic">knetworkmanager</span> instead.)  
		Once Network Manager has been installed, <strong>reboot</strong> the computer.</em></li>  
		<img src="../images/wireless/wireless-ubuntu-02.png" alt="wireless-ubuntu-02" width="575" class="imgBorder">
		<li>For Ubuntu, you can execute the command:</li>
		<br />
    ...
    <li>
        ...
        <li>Enter "access 30" into the Network Name field and select "WPA Enterprise" from the Wireless Security field.</li>
		<img class="imgBorder" src="../images/wireless/wireless-access30-ubuntu-01.png" alt="wireless-access30-ubuntu-01">
        <li>In the dialog box that follows, enter the following values:
		<ul><li>Network Name: <strong>access 30</strong></li>
	...
	<li>Once the information is entered, click the "Connect" button.
		<img class="imgBorder" src="../images/wireless/wireless-access30-ubuntu-02.png" alt="wireless-access30-ubuntu-02">
