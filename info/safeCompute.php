...
<body>
	...
	<?php include_once("../includes/header_secondary.inc.php") ?>
            ...
            <p class="indent">
                ...
                Additionally ResNet requires all students to use the firewall software included with their operating system to compliment the campus wide firewall.
                For additional information on the campus firewall, please visit Networking Services <a href="https://networking.missouristate.edu/Policies/FirewallExceptions.aspx">Internet Firewall</a> page.
              </p>
