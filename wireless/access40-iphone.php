...
<title>Resnet :: Tutorials :: Wireless :: Configuring Access 40 on Apple iPhone / iPod Touch</title>
...
<body>
	...
	<?php include_once("../includes/header_secondary.inc.php") ?>
    		...
    		<div id="tutorial"> 
            <!-- start content -->		
            <h2>Configuring Access 40 on Apple iPhone / iPod Touch</h2>
            <p class="answer">
            ...
            <ol class="indent">
                ...
                <li>Tap "access 40" from the "Wi-Fi Networks" screen.</li>
                    <img class="imgBorder" src="../images/wireless/wireless-iphone-03.png" alt="iPhone Wi-Fi Networks Screen" />
                <li>
                	...
                	<img class="imgBorder" src="../images/wireless/wireless-access40-iphone-01.png" alt="iPhone Wi-Fi Credentials Screen" />
                <li>
                    Tap <strong>Accept</strong> to accept the server certificate.</li>
                    <img class="imgBorder" src="../images/wireless/wireless-access40-iphone-02.png" alt="iPhone Wireless Certificate Screen" />
                <li>
                    You are now connected to "access 40".</li>
                    <img class="imgBorder" src="../images/wireless/wireless-access40-iphone-03.png" alt="iPhone Wi-Fi Networks Configured Screen" />	
            </ol> 
            <p class="answer">
