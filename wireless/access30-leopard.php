...
<title>Resnet :: Tutorials :: Wireless :: Configuring Access 30 on Mac OS X (10.5) - Leopard</title>
...
<body>
	...
	<?php include_once("../includes/header_secondary.inc.php") ?>
            ...
            <li>Click on the + (plus) button in the lower left-hand corner, select <strong>Add User Profile</strong>, and then type a name for the configuration (e.g., access 30).</li>
            <li>On the right, enter the following information:
            	<ul>
                    ...
                    <li>Wireless Network: <strong>access 30</strong></li>
                    <li>Authentication: <strong>PEAP</strong></li>
            	</ul>
                    <em>(Other autentications methods may be checked, but PEAP is required.  Optionally, you can drag it to the top of the list.)</em>
            </li>
                    <img class="imgBorder" src="../images/wireless/wireless-access30-OSX-1.png" alt="wireless-access30-OSX-1">
             <li>Click <strong>OK</strong></li>
             <li>Click <strong>Apply</strong>
                    &nbsp;&#8658&nbsp;<em><strong>You are now finished!</strong>  When in an area with Missouri State wireless coverage, 
                    select "access 30" from the Airport menu to connect.
                    (If asked, press "Continue" to verify the certificate.)</em></li>	
                    <br /><img class="imgBorder" src="../images/wireless/client%20certificate-OSX.png" alt="Client Certificate OSX">
			</ol>
