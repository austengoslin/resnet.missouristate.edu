...
<title>Resnet :: Tutorials :: Wireless :: Configuring Access 40 on Mac OS X (10.5) - Leopard</title>
...
<body>
	...
	<?php include_once("../includes/header_secondary.inc.php") ?>
    		...
    		<div id="tutorial"> 
            <!-- start content -->		
            <h2>Configuring Access 40 on Mac OS X (10.5) - Leopard</h2>
            <p class="answer"><a href="../PDF/WirelessNetworks/Access40/ConfiguringAccess40onMacOS10.5.pdf">Printer Friendly Version (PDF)</a></p>
            ...
            <ol class="indent">
                ...
                <li>Click on the + (plus) button in the lower left-hand corner, select <strong>Add User Profile</strong>, and then type a name for the configuration (e.g., access 40).</li>
              <li>On the right, enter the following information:
                    ...
                    <img src="../images/wireless/wireless-access40-OSX-1.png" alt="wireless-access40-OSX-1" width="575" class="imgBorder">
                <li>Click <strong>OK</strong></li>
                <li>Click <strong>Apply</strong></li>
              </ol>
                
              <p class="indent"><em><strong>You are now finished!</strong>  When in an area with Missouri State wireless coverage, select <strong>"access 40"</strong> from the Airport menu to connect.
                  (If asked, press "Continue" to verify the certificate.)</em>
                    <br /><img src="../images/wireless/client%20certificate-OSX.png" alt="Client Certificate OSX" width="575" class="imgBorder">
                </p>
             <p class="answer">
